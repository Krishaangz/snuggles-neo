...
import founderImage from "@/assets/ceo-kayze.png";
      ...
      <div className="container relative z-10 mx-auto px-4">
        <div className="text-center max-w-4xl mx-auto mb-16 space-y-6 animate-fade-in">
          ...
          <p className="text-xl text-muted-foreground leading-relaxed">
            At Snuggles, we're reimagining babycare for the modern world — blending science, empathy, and verified AI to guide parents confidently through every step of nurturing.
          </p>
        ...
        <div className="max-w-3xl mx-auto mb-16">
          <Card 
            className="p-8 gradient-card shadow-medium hover:shadow-float transition-all border-2 animate-fade-in"
          >
            <div className="flex flex-col md:flex-row items-center gap-8">
              <div className="w-32 h-32 rounded-full overflow-hidden border-4 border-primary/20 flex-shrink-0 animate-float">
                <img 
                  src={founder.image} 
                  alt={founder.name}
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <div className="relative pl-6 border-l-4 border-primary/30 text-left">
